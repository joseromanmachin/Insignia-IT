    ...
    <head>
        ...
        <body>
            <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                <a class="navbar-brand text-white" style="margin-left: 50px; "  href="index.html">
            ...
            <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="menu">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                            <a href="contacto.php" class="nav-link seleccionado"><strong>Contacto</strong> </a>
                        </li>
                        <li class="nav-item active">
            ...
            <div class="container animated animate fadeInUp">
                <!--Contacto-->
                <div class="row" id="contenedor-contactanos">
                    ...
                    <div class="col-sm-6 col-12 contacto">
                        <br>
                        <br>
                        <h1>Estás a un clic de <br> <b>encontrar tu solución</b> </h1> <br>
